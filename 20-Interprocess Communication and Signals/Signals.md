...
### Output
```text
C:\Users\ASUS\Documents\Intermediate_C\20-Interprocess_communication_and_signals\Handling_a_signal_using_sigaction>main.exe
Running...
Running...
Signal received: 2
Running...
...
when i press ctl + c, it prints the message Signal received: 2

The handler receives an integer that represents the signal number; SIGINT corresponds to value 2.
